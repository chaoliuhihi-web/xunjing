...
public class RoleServiceImpl implements RoleService {
    ...
    void validateRoleDuplicate(String name, String code, Long id) {
        ...
        RoleDO role = tenantId != null ? roleMapper.selectByNameAndTenantId(name, tenantId)
                : roleMapper.selectByName(name);
        ...
        // 该 code 编码被其它角色所使用
        role = tenantId != null ? roleMapper.selectByCodeAndTenantId(code, tenantId)
                : roleMapper.selectByCode(code);
        if (role != null && !role.getId().equals(id)) {
