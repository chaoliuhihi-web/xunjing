...
public class AiModelServiceImpl implements AiModelService {
    ...
    public AiModelDO getModel(Long id) {
        return AiRuntimeTenantRouter.executeForRuntimeTenant(() -> modelMapper.selectById(id));
    }

    @Override
    public AiModelDO getRequiredDefaultModel(Integer type) {
        AiModelDO model = AiRuntimeTenantRouter.executeForRuntimeTenant(
