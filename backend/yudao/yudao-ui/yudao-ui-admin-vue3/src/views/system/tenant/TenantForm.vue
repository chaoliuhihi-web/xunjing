  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="50%">
    ...
    >
      ...
      <el-form-item label="租户套餐" prop="packageId">
        <template v-if="isSystemTenantEdit">
          <el-tag type="danger">系统租户</el-tag>
          <span class="ml-2 text-[var(--el-text-color-secondary)]">系统套餐固定，不支持修改</span>
        </template>
        <el-select v-else v-model="formData.packageId" clearable placeholder="请选择租户套餐">
          <el-option
      ...
      <el-form-item label="租户状态" prop="status">
        <el-radio-group v-model="formData.status" :disabled="isSystemTenantEdit">
          <el-radio
...
const isSystemTenantEdit = computed(
  () => formType.value === 'update' && formData.value.packageId === 0
)
