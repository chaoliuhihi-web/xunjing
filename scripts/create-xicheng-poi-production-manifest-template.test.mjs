...
describe('xicheng POI production manifest template generator', () => {
  ...
  test('prefills the production manifest draft from the current local candidate seed without marking it production ready', async () => {
    ...
    expect(manifest.pois.find((poi) => poi.poiCode === 'xicheng-emperors-temple').source.sourceUrl).toBe('https://www.bjxch.gov.cn/xxgk/zdly/jgxx/lyscjg/Ajjyxlyjqml.html#xicheng-emperors-temple')
    expect(manifest.pois.find((poi) => poi.poiCode === 'xicheng-shichahai').source.sourceUrl).toBe('https://www.bjxch.gov.cn/xxgk/zdly/jgxx/lyscjg/Ajjyxlyjqml.html#xicheng-shichahai')
    expect(manifest.pois.find((poi) => poi.poiCode === 'xicheng-financial-street').source.sourceUrl).toBe('https://www.bjxch.gov.cn/xxgk/zdly/jgxx/lyscjg/Ajjyxlyjqml.html#xicheng-financial-street')
